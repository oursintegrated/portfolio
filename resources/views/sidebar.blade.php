<div class="col-sm-auto bg-light sticky-top" style="background-color: white !important  ; padding-left: 0; padding-right: 0;">
    <div class="d-flex flex-sm-column flex-row flex-nowrap bg-light align-items-center sticky-top" style="background-color: white;">
        <!-- <a href="/" class="d-block p-3 link-dark text-decoration-none" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Icon-only">
            <i class="bi-bootstrap fs-1"></i>
        </a> -->
        <ul class="nav nav-pills nav-flush flex-sm-column flex-row flex-nowrap mb-auto mx-auto text-center justify-content-between w-100 align-items-center" style="background-color: white;">
            <li class="nav-item">
                <a href="#" class="nav-link px-2" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Home">
                    <img src="/images/icons/home.jpg" class="icon-sidebar" />
                </a>
            </li>
            <!-- <li>
